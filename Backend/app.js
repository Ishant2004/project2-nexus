...
mongoose
  .connect("mongodb://localhost:27017/techify_db", {
...
app.put("/ideas/:id/comments/:comment_id", function (req, res) {
  Cmntidea.findByIdAndUpdate(
    req.params.comment_id,
    req.body.comment,
    function (err, updatedCmnt) {
      if (err) {
